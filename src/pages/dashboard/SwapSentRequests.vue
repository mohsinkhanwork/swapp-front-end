                ...
                <div class="flex flex-wrap items-center justify-between gap-6">
                    <div class="flex flex-wrap items-center gap-5">
                        ...
                        >
                            ...
                            <CommonRequestDropdown :userId="request.user.id" />
                        </div>
                    </div>
                    <div v-if="request.status == 'pending'" class="flex flex-wrap items-center gap-4">
                        ...
                        <!-- <a
                            ...
                            >{{ $t('view_profile') }}</a
                        > -->
                        <router-link :to="`/users/${request.user.username}/${request.user.id}`" class="btn py-[5px]">{{ $t('view_profile') }}</router-link>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async swapRequests() {
            try {
                const response = await axios.get(`/skill/sent-swap-requests`);
